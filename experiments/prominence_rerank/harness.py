...
prominence.rank_prominence - candidate generation, dedup, center tiebreak,
and refinement are all the UNMODIFIED production functions, called
directly.
"""
...
from prominence import rank_prominence


def localize_prominence(reference_img, search_img, *,
                         ...
                         inner_exclude_px: float = 2.0, annulus_outer_px: float = 12.0,
    ...
    ranked = rank_prominence(candidates, reference, search, top_k=top_k, gamma=gamma,
                              inner_exclude_px=inner_exclude_px, annulus_outer_px=annulus_outer_px)
    ...
    return LocalizationResult(
        ...
        runtime_s=runtime_s, ranking_mode="prominence", num_candidates=len(candidates),
        top_candidates=[
