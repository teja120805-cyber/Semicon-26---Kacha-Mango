...
pitch_aware_v2.rank_pitch_aware_prominence_v2 - candidate generation,
dedup, center tiebreak, and refinement are all the UNMODIFIED production
...
from pitch_aware_v2 import rank_pitch_aware_prominence_v2


def localize_pitch_aware_v2(reference_img, search_img, *,
    ...
    ranked = rank_pitch_aware_prominence_v2(candidates, reference, search, top_k=top_k, gamma=gamma,
    ...
    return LocalizationResult(
        ...
        runtime_s=runtime_s, ranking_mode="pitch_aware_prominence_v2", num_candidates=len(candidates),
        top_candidates=[
